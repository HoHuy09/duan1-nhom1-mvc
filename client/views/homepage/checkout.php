                        ...
                        <div class="rounded-t mb-0 px-4 py-3 border-0">
                            <div class="flex flex-wrap items-center">
                                <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                                    <h3 class="font-semibold  text-base text-blueGray-700 text-2xl">Danh Sách Sản Phẩm</h3>
                                </div>
                        ...
                        <form action="pay-cart" method="post">
                            <div class="md:flex items-center mt-12">
                                <div class="w-full md:w-1/2 flex flex-col">
                                    <label class="font-semibold leading-none text-2xl">Họ Tên</label>
                                ...
                                <div class="w-full md:w-1/2 flex flex-col md:ml-6 md:mt-0 mt-4">
                                    <label class="font-semibold leading-none text-2xl">Phone</label>
                            ...
                            <div class="md:flex items-center mt-8">
                                <div class="w-full flex flex-col">
                                    <label class="font-semibold leading-none text-2xl">Email</label>
                            ...
                            <div class="md:flex items-center mt-8">
                                <div class="w-full flex flex-col">
                                    <label class="font-semibold leading-none text-2xl">Địa Chỉ Nhận Hàng</label>
                            ...
                            <div class="md:flex items-center mt-8">
                                <div>
                                    <div class="w-full flex flex-col mt-8">
                                        <label class="font-semibold leading-none text-2xl">Ghi Chú</label>
                                ...
                                <div class="flex items-center justify-center w-full">
                                    <button type="submit" class="mt-9 text-2xl font-semibold leading-none text-white py-4 px-10 bg-blue-700 rounded hover:bg-blue-600 focus:ring-2 focus:ring-offset-2 focus:ring-blue-700 focus:outline-none">
                                        Gửi
                                    </button>
                                </div>
                        </form>
