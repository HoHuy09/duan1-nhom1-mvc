...
<div class="min-h-screen  items-center ">
    <div class="container mx-auto p-12 bg-gray-100 rounded-xl">
        <h1 class="text-4xl uppercase font-bold text-center from-current mb-8">Những Tin Tức Đáng Chú Ý</h1>
        <!-- Box-1 -->
                        ...
                        <div class="shadow-lg hover:shadow-xl transform transition duration-500 hover:scale-105">
                            <div>
                                ...
                                <div class="px-4 py-2">
                                    ...
                                    <button class="mt-12 text-xl w-full text-center bg-yellow-400 py-2 rounded-lg">Xem Thêm</button>
